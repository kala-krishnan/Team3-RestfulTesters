...
public enum APIResources {
	...
	APIGetUserBatchID("/users/user/{userId}"),
	APIGetAllUserRoles("/users/roles"),
	APIGetUserByRoleID("/users/roles/{roleId}"),
	APIGetByProgramID("/users/programs/{programId}"),
	APIGetByBatchID("/users/programBatch/{batchId}"),
	APIGetUserByUserID("/users/details/{userId}"),
