...
#get by parameter for roleid,id,userid valid
...
#get by parameter for programid,batchid valid
@getuserprmbatch
...
|PutUserRolebyUserIdInvalidRolestatus|400|
|PutUserRolebyUserIdInvalidEndpoint|400|
